...
public class LocationEndpoint {
	...
	@GET
	@Produces("application/json")
	public List<Location> listAll(@QueryParam("start") Integer startPosition,
			@QueryParam("max") Integer maxResult) {
		TypedQuery<Location> findAllQuery = em.createQuery(
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") Float id, Location entity) {
		if (entity == null) {
